...
class Collect(object):
    def __init__(self, domain):
        ...
        self.blocked_modules = {
            ...
            'modules.search.wzsearch',
            'modules.datasets.cebaidu',
            'modules.datasets.qianxun',
        ...
        if settings.enable_all_module:
            ...
            for module in modules:
                ...
                for path in module_path.rglob('*.py'):
                    ...
                    if import_module in self.blocked_modules:
                        continue
                    self.modules.append(import_module)
        else:
            self.modules = [
                module for module in settings.enable_partial_module
                if module not in self.blocked_modules
            ]
